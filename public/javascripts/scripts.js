  ...
  (function() {
    ...
    try {
      ...
      $(document).ready(function(){
        ...
        if(top_products_count > 1) { 
          $('.top_products_nav').css('display','block');
        }else {
          $('.top_products_nav').css('display','none');
        }
...
// latest sneaker slider on homepage
$(document).ready(function() {
  var index_products_count = $('.loadItems li.item-row').length;
  if (index_products_count > 4) {
      $('.nav_top_items').css('display', 'block');
  } else {
      $('.nav_top_items').css('display', 'none');
  }
